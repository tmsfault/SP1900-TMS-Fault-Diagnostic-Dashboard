...
let circuitDiagrams = {
  'TMS': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/TMS.pdf',
  'CAB': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/CAB.pdf',
  'VOBC': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/VOBC.pdf',
  'BRAKE': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/BRAKE.pdf',
  'CI1': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/CI.pdf',
  'CI2': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/CI.pdf',
  'SIV1': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/SIV.pdf',
  'SIV2': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/SIV.pdf',
  'DCU U': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/DCU.pdf',
  'DCU D': 'https://tmsfault.github.io/SP1900-TMS-Fault-Diagnostic-Dashboard/circuits/DCU.pdf',
...
function createSitemapNode(faultNo, tilde) {
  ...
  nodeContent.innerHTML = `
    <table class = "Sitemap">
      ...
      ${faultRow['D1'] ? `<tr><th>I/F Type</th><td>${faultRow['D1']}</td></tr>` : ''}
      ${faultRow['Car Type'] || faultRow['Level'] ?
        (tilde ?
          faultRow['Car Type'] ?
          ...
          faultRow['Car Type'] ?
            `<tr><th>Detect</th><td><b>${faultRow['Level']}</b><br>${faultRow['Car Type']}</td></tr>` :
            `<tr><th>Detect</th><td><b>${getLevelHtml(faultRow['Level'], tilde)}</b></td></tr>`
        ) :
        ''
      }
...
function createTreeNode(faultNo, tilde) {
  ...
  nodeContent.innerHTML = `
    <table style="table-layout: fixed;">
      ...
      ${faultRow['D1'] ? `<tr><th style="width: 100px;">I/F Type</th><td>${faultRow['D1']}</td></tr>` : ''}
      ${faultRow['Car Type'] || faultRow['Level'] ?
        (tilde ?
          faultRow['Car Type'] ?
          ...
          faultRow['Car Type'] ?
            `<tr><th style="width: 100px;">Detect</th><td><b>${faultRow['Level']}</b><br>${faultRow['Car Type']}</td></tr>` :
            `<tr><th style="width: 100px;">Detect</th><td><b>${getLevelHtml(faultRow['Level'], tilde)}</b></td></tr>`
        ) :
        ''
      }
